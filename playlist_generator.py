...
class PlaylistGenerator:
    ...
    def create_rag_prompt(self, suitable_tracks, target_duration_ms):
        ...
        try:
            ...
            주어진 업무를 성실히 수행하시오. 업무를 수행할 땐 반드시 아래 지시사항을 따라야 합니다.
            <thinking> 섹션으로 답변을 시작하시오.	
            <thinking> 섹션 내부에서는 :	
            a. 업무를 간단히 분석하고 접근 방식을 개략적으로 설명합니다. 
            b. 문제를 해결하기 위한 명확한 단계 계획을 제시하오. 
            c. 필요한 경우 추론과정을 번호로 나누어 설명하시오. 
            d. 업무를 수행하기 위해 필요한 추가 정보가 필요하면 지체없이 질문하시오. 
            e. 각 단계의 추론 과정을 논리적이고 정확하게 접근하는 것을 목표로 하며, 복잡한 업무를 더 간단한 구성 요소로 나누는 것을 주저하지 마시오. 

            최종 답변은 <output> 섹션에 제공하시오. 
            a. 답변 톤은 분석적이고 공식적이어야 합니다. 
            b. 주어진 업무에 대해 답변이 충족한지 확인하고, 충족하지 않았다면 답변을 끝내지 마시오. 
            </지시사항>
            <업무1>
